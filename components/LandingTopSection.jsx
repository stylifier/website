        ...
        <div className="row">
          <div className="col-lg-6 col-md-10 col-sm-10 col-xs-12">
            <div style={{margin: 20, marginTop: '10%'}}>
              {this.props.message.split(' ').map((i, t) => <p key={t} style={{ color: 'black', background: 'white', float: 'left', margin: '10 10 0 0', padding: '10 5 10 5', fontSize: window.innerWidth > 768 ? '4em' : '3em'}}>{i}</p>)}
            </div>
          </div>
        </div>
